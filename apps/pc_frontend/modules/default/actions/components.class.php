...
class defaultComponents extends sfComponents
{
  public function executeGlobalNav()
  {
    ...
    $this->navs = $this->getEntityManager()->getRepository('Navigation')->retrieveByType($type);
  }
  ...
  public function executeLocalNav()
  {
    ...
    $this->navs = $this->getEntityManager()->getRepository('Navigation')->retrieveByType($this->type);
  ...
  {
    $gadgets = $this->getEntityManager()->getRepository('Gadget')->retrieveGadgetsByTypesName('sideBanner');
    $this->gadgets = $gadgets['sideBannerContents'];
  }

  public function executeInformationBox()
  {
    $this->information = opConfig::get('pc_home_information');
  }
